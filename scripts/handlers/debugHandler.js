...
export function debugHandler(player, tps) {
    ...
    /** Dev testing stuff */
    player.onScreenDisplay.setActionBar(`${config.themecolor}Debug §j> §8Ground-Distance: ${player.location.y - player.lastGoodPosition.y > 1.3 ? "§c" : "§8"}${player.location.y - player.lastGoodPosition.y}`);
